...
void DivElem::startElement (const char* const name, const xercesc::Attributes &attrs ){
	...
	if ( CTX->firstTag ) {
		...
		if ( type.compare("Monograph")==0 ){
			append = " xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"http://downloads.bnl.lu/schemas/bnl-monograph_v2.0.xsd\" xsi:schemaLocation=\"http://downloads.bnl.lu/schemas/bnl-monograph_v2.0.xsd bnl-monograph_v2.0.xsd\" ";
