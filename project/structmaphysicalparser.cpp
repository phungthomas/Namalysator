...
void structmaphysicalparser::startElement(const char *name, const char **atts)
{	
...
bool structmaphysicalparser::endElement(const char *name)
{ 	
...
void structmaphysicalparser::characterData(const char *s, int len)
{	
}
