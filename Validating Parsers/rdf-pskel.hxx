...
#ifndef CXX_________DATA_SCHEMAS_RDF_PSKEL_HXX
#define CXX_________DATA_SCHEMAS_RDF_PSKEL_HXX
...
namespace rdf
{
  class RDF_pskel: public ::xml_schema::complex_content
  {
    public:
    ...
    //
    void
    Description_parser (::rdf::Description_pskel&);
    ...
    protected:
    ::rdf::Description_pskel* Description_parser_;

    protected:
    struct v_state_descr_
    {
      void (::rdf::RDF_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
  ...
  class Description_pskel: public ::xml_schema::complex_content
  {
    ...
    struct v_state_descr_
    {
      void (::rdf::Description_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX_________DATA_SCHEMAS_RDF_PSKEL_HXX
