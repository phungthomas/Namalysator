...
#ifndef CXX_________DATA_SCHEMAS_DC_PSKEL_HXX
#define CXX_________DATA_SCHEMAS_DC_PSKEL_HXX
...
namespace dc
{
  class elementType_pskel: public virtual ::xml_schema::string_pskel
  {
    public:
...
#endif // CXX_________DATA_SCHEMAS_DC_PSKEL_HXX
