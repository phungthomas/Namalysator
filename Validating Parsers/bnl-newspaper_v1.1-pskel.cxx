...
#include "bnl-newspaper_v1.1-pskel.hxx"
...
HEADING_parser (::ct_SECTION_HEADING_pskel& p)
{
    ...
    case 0UL:
    {
      if (n == "HEADING" && ns.empty ())
      {
        ...
        else
        {
          if (this->HEADING_parser_)
          {
            this->HEADING_parser_->post_ct_SECTION_HEADING ();
            this->HEADING ();
          }
...
// Element validation and dispatch functions for ct_SECTION_HEADING_pskel.
//
bool ct_SECTION_HEADING_pskel::
_start_element_impl (const ::xml_schema::ro_string& ns,
                     const ::xml_schema::ro_string& n,
                     const ::xml_schema::ro_string* t)
{
  ...
  if (vd->func == 0)
  {
    if (vd->state != ~0UL)
    {
      ...
      if (s != ~0UL)
      {
        ...
        vd = vs.data + vs.size++;
        vd->func = &ct_SECTION_HEADING_pskel::choice_0;
        vd->state = s;
        vd->count = 0;
